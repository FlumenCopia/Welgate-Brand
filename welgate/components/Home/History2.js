...
function History2() {
  return (
    <div>
        <section className="formula-area2" >
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-lg-5 order-0 order-lg-0">
                            <div className="formula-img2">
                                <img  src="/assets/img/WhatsApp Image 2025-05-12 at 14.39.11_b5a8f290.jpg" alt="img"  style={{width:'400px',borderRadius:'20px'}}/>
                            </div>
                        </div>
                        <div className="col-lg-7">
                            <div className="formula-content">
                                <div className="section-title white-title mb-50">
                                    ...
                                    <p className="title text-white">The Shift to Farm Fresh
</p>
                                </div>
