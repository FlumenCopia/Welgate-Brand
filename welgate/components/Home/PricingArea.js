...
function PricingArea() {
  return (
    <div>
      <section style={{
          position: 'relative',width: '100%',height: '500px',backgroundImage: "url('/assets/img/bg/shutterstock_1008530026_1_2_beaeb9bb2d.webp')",backgroundSize: 'cover' ,backgroundPosition: 'center',
        }}>
    ...
    <div class="container-fluid pt-5 pb-5" style={{paddingBottom:'25px',paddingTop:'20px'}}>
        <div class="container pt-4">
            <div class="row g-0 feature-row wow fadeIn" data-wow-delay="0.1s">
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.3s">
                    <div class="feature-item border h-100 bg-yellow">
                        ...
                        <div class="p-5 pt-0">
                            ...
                            <p style={{textAlign:'justify'}}> Supporting organic and local farmers through fair practices, education, and long-term partnerships that sustain rural livelihoods.</p>
                ...
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.4s">
                    <div class="feature-item border h-100 bg-yellow">
                        ...
                        <div class="p-5 pt-0">
                            ...
                            <p style={{textAlign:'justify'}}> Investing in eco-friendly farming methods that protect soil health, conserve water, and reduce chemical use — for people and the planet.</p>
                            <a class="position-relative text-body text-uppercase small d-flex justify-content-between"
                                href="#">
                                  {/* <b class="bg-white pe-3">Read More</b>  */}
                                  {/* <i class="bi bi-arrow-right bg-white ps-3"></i> */}
                ...
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.5s">
                    <div class="feature-item border h-100 bg-yellow">
                        ...
                        <div class="p-5 pt-0">
                            ...
                            <p style={{textAlign:'justify'}}> Creating accessible health and wellness solutions that nourish the body and uplift communities through ethical products.</p>
                            <a class="position-relative text-body text-uppercase small d-flex justify-content-between"
                                href="#">
                                  {/* <b class="bg-white pe-3">Read More</b>  */}
                                {/* <i class="bi bi-arrow-right bg-white ps-3"></i> */}
                ...
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.6s">
                    <div class="feature-item border h-100 bg-yellow">
                        ...
                        <div class="p-5 pt-0">
                            ...
                            <p style={{textAlign:'justify'}}> From music that once united hearts to health initiatives that strengthen lives, our roots continue to inspire meaningful impact.</p>
                            <a class="position-relative text-body text-uppercase small d-flex justify-content-between"
                                href="#">
                                  {/* <b class="bg-white pe-3">Read More</b>  */}
                                {/* <i class="bi bi-arrow-right bg-white ps-3"></i> */}
