                    ...
                    <div className="row align-items-center justify-content-center">
                        ...
                        <div className="col-xl-6 col-lg-6 col-md-10">
                            <div className="tg-banner-content">
                                <h4 className="sub-title wow fadeInUp" data-wow-delay=".2s">Timeless Legacy !</h4>
                                <h2 className="title wow fadeInUp" data-wow-delay=".4s"> Honoring <span className='bannertextclr'>the Past,</span> Cultivating <span className='bannertextclr'> the Future</span></h2>
