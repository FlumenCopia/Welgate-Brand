                        ...
                        <div className="row justify-content-center">
                            <div className="col-lg-8">
                                <div className="tg-section-title text-center mb-60">
                                    ...
                                    <h2 className="title">Welgate’s Journey: <br/> “From Soundwaves to Superfoods”</h2>
                                </div>
                            </div>
                        </div>
                        <div className="row justify-content-center">
                            <div className="col-lg-4 col-md-6 col-sm-9">
                                <div className="tg-service-item">
                                    ...
                                    <h2 className="title"><a href="contact.html">Where It All Began</a></h2>
                            ...
                            <div className="col-lg-4 col-md-6 col-sm-9">
                                <div className="tg-service-item">
                                    ...
                                    <h2 className="title"><a href="contact.html">A Natural Shift</a></h2>
                                    <div className="tg-service-content">
                            ...
                            <div className="col-lg-4 col-md-6 col-sm-9">
                                <div className="tg-service-item">
                                    ...
                                    <h2 className="title"><a href="contact.html">From Soil to Shelf</a></h2>
                                    <div className="tg-service-content">
                            ...
                            <div className="col-lg-4 col-md-6 col-sm-9">
                                <div className="tg-service-item">
                                    ...
                                    <h2 className="title"><a href="contact.html">Sown to Sold</a></h2>
                                    <div className="tg-service-content">
